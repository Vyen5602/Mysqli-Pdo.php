...
$sql_stml .= "VALUES ('SV001','Vũ Thị Hải Yến','2002-01-24','K56SD','10'),
        ('SV002','Vũ Minh Huy','2002-03-02','K56SD','9.6'),
        ('SV003','Vũ Thị Ngọc Ánh','2002-08-03','K56SD','8.2'),
        ('SV004','Vũ Minh Đức','2003-10-12','K56SD','9.5'),
        ('SV005','Nguyễn Quang Sơn','2003-07-20','K56SD','7.5')";
$result = mysqli_query($dbh,$sql_stml);
if (!$result) {
